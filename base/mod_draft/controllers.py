...
# @base.route("/<lang_code>/group/<groupname>/register/", methods=['POST'])
# def register_via_invite():
#     # full name, token, password, is_gmail, creation_date, phone numbers
#     return render_template('register.html')
# @base.route("/<lang_code>/group/getall/")
# def groups():
#     # return all groups user belongs to along with is_admin info
#     return render_template('register.html')
# @base.route("/<lang_code>/term/<termname>/", methods=['GET','POST','DEL'])
# def term(termname):
...
#     return render_template('register.html')
# @base.route("/<lang_code>/terms/")
# def terms():
#     # return all terms for a <group>
#     return render_template('register.html')

# @base.route("/<lang_code>/summon/")
# def summon():
